...
export function MoneySources({
  ...
  return (
    <section className="space-y-2.5">
      ...
      {/* 4 Accounts Grid Matching Reference Image */}
        ...
        {accounts.map((acc) => {
          ...
          return (
            <div
              ...
              className="bg-white rounded-2xl border border-slate-200/80 p-2.5 sm:p-3 flex flex-col items-center justify-center text-center shadow-2xs hover:shadow-xs hover:border-slate-300 transition-all cursor-pointer group relative"
            >
              {/* Account Icon */}
              ...
              {/* Account Name */}
              <span className="text-[11px] sm:text-xs font-bold text-slate-800 truncate w-full mb-1">
                {displayName}
              </span>
